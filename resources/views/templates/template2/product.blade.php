...
<section id="advertisement">
    <div class="container">
        <img src="{{asset('templates/template2/images/shop/advertisement.jpg')}}" alt="" />
    </div>
</section>
            ...
            <div class="col-sm-3">
                <div class="left-sidebar">
                    ...
                    <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href='{{url("/product?categorie=$row->id")}}'>{{$row->name}}</a></h4>
                            </div>
                        </div>
                        @endforeach
                        <!-- <div class="panel panel-default">
                    ...
                    <div class="shipping text-center"><!--shipping-->
                        <img src="{{asset('templates/template2/images/home/shipping.jpg')}}" alt="" />
                    </div><!--/shipping-->
                            ...
                            <div class="single-products">
                                ...
                                {{-- <div class="product-overlay">
                                    <div class="overlay-content">
                                        <h2>{{$row->name}}</h2>
                                        <p>Price :{{$row->price}}</p>
                                    <button data-id="{{$row->id}}" @guest data-user_id=null @else data-user_id={{Auth::id()}} @endguest  class="btn btn-default add-to-cart">
                                    <i class="fa fa-shopping-cart"></i>Add to cart</button>
